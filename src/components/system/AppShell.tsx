...
const NAV_ITEMS = [
  ...
  { id: 'deals', label: 'Deals', href: '/deals', Icon: Target },
  { id: 'rank-tracker', label: 'Rank Tracker', href: '/rank-tracker', Icon: Search },
  { id: 'call-center', label: 'Call Center', href: '/call-center', Icon: Phone },

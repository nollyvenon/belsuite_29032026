...
/**
 * Additive Prisma-shaped tables when absent (SQLite CI or fresh install).
 * Existing PostgreSQL + Prisma: tables already exist — no-op.
 */
return new class extends Migration
{
    ...
    {
        // Intentionally empty: avoid dropping live Prisma-managed tables on rollback.
    }
};
